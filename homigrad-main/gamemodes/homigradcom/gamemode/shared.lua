-- "gamemodes\\homigradcom\\gamemode\\shared.lua"
...
--hg.includeDir("gamemodes/homigradcom/game/")ебланы

include("loader.lua")

local start = SysTime()
print("	start homigradcom gamemode.")

GM.includeDir("homigradcom/gamemode/game/")--все файлы запускает, когда обновляем один.. можно из этого даже чо-то сделать.нахуй

print("	end homigradcom gamemode for " .. math.Round(SysTime() - start,4) .. "s")
