-- "gamemodes\\homigradcom\\gamemode\\game\\levels\\bahmut\\init_tier_0_sh.lua"
...
function bahmut.StartRound()
	...
	if not file.Read("homigradcom/maps/controlpoint/" .. game.GetMap() .. ".txt", "DATA") and SERVER then
