-- "gamemodes\\homigradcom\\gamemode\\game\\levels\\hunter\\init_cl.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
hunter.GetTeamName = tdm.GetTeamName

local colorSpec = ScoreboardSpec

function hunter.Scoreboard_Status(ply)
...
function hunter.HUDPaint_RoundLeft(white2, time)
	...
	if lply:Team() == 3 or lply:Team() == 2 or not lply:Alive() and hunter.police and time < 0 then
...
function hunter.PlayerClientSpawn()
