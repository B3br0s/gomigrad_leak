-- "gamemodes\\homigradcom\\gamemode\\game\\levels\\hl2dm\\init_cl.lua"
...
function hl2dm.HUDPaint_RoundLeft(white)
	...
	if startRound > 0 and lply:Alive() then
		...
		if lply:Team() == 1 then draw.DrawText(language.GetPhrase("hg.hl2dm.desc2"), "HomigradRoundFont", ScrW() / 2, ScrH() / 1.1, Color(65, 65, 65, math.Clamp(startRound, 0, 1) * 255), TEXT_ALIGN_CENTER) end
		return
	end
end