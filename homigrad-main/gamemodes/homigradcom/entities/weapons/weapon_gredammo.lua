-- "gamemodes\\homigradcom\\entities\\weapons\\weapon_gredammo.lua"
...
if SERVER then
	...
	function SWEP:DrawWorldModel()
		...
		self:CallOnRemove("hg_removegregammo", function() mdl:Remove() end)
	...
	function SWEP:DrawHUD()
		...
		draw.SimpleText("#hg.hint.pickup", "DebugFixedSmall", ScrW() / 2, ScrH() - 125, white, TEXT_ALIGN_CENTER)
		draw.SimpleText("#hg.hint.show", "DebugFixedSmall", ScrW() / 2, ScrH() - 100, white, TEXT_ALIGN_CENTER)
	end
end