-- "gamemodes\\homigradcom\\entities\\weapons\\weapon_hg_melee_base.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
SWEP.Base = "weapon_base"

if CLIENT then
	SWEP.PrintName = language.GetPhrase("hg.bayonet.name")
	SWEP.Instructions = language.GetPhrase("hg.bayonet.inst")
...
function SWEP:Deploy()
	...
	if SERVER then self:GetOwner():EmitSound(self.DrawSound, 60) end
end
