-- "gamemodes\\homigradcom\\entities\\weapons\\weapon_hk416.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
SWEP.Base = "salat_base"

if CLIENT then
	SWEP.PrintName = language.GetPhrase("hg.hk416.name")
	SWEP.Author = "homigradcom"
	SWEP.Instructions = language.GetPhrase("hg.hk416.inst")
