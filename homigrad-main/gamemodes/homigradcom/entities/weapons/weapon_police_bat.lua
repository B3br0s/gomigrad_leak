-- "gamemodes\\homigradcom\\entities\\weapons\\weapon_police_bat.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
SWEP.Base = "weapon_base"

if CLIENT then
	SWEP.PrintName = language.GetPhrase("hg.baton.name")
...
function SWEP:PrimaryAttack()
	...
	if true then
		if SERVER and tr.HitWorld then self:GetOwner():EmitSound("physics/body/body_medium_impact_soft7.wav") end
