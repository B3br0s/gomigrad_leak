-- "gamemodes\\homigradcom\\entities\\weapons\\weapon_hands_fast.lua"
...
if SERVER then
	...
	SWEP.PrintName = language.GetPhrase("hg.handsfast.name")
	SWEP.Instructions = language.GetPhrase("hg.handsfast.inst")
	SWEP.Slot = 0
	SWEP.SlotPos = 1
	SWEP.DrawAmmo = false
