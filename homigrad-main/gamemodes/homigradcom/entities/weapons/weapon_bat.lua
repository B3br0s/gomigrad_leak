-- "gamemodes\\homigradcom\\entities\\weapons\\weapon_bat.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
SWEP.Base = "weapon_base"

if CLIENT then
	SWEP.PrintName = language.GetPhrase("hg.bat.name")
	SWEP.Author = "homigradcom"
	SWEP.Instructions = language.GetPhrase("hg.bat.inst")
...
function SWEP:PrimaryAttack()
	...
	if true then
		if SERVER and tr.HitWorld then self:GetOwner():EmitSound("physics/wood/wood_plank_impact_hard" .. math.random(1, 5) .. ".wav", 60) end
