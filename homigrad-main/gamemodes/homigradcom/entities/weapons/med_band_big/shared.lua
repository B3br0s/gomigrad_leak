-- "gamemodes\\homigradcom\\entities\\weapons\\med_band_big\\shared.lua"
...
if CLIENT then
	SWEP.PrintName = language.GetPhrase("hg.bigband.name")
	SWEP.Author = "homigradcom"
	SWEP.Instructions = language.GetPhrase("hg.bigband.inst")
