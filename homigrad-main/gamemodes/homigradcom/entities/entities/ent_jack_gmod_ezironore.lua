-- "gamemodes\\homigradcom\\entities\\entities\\ent_jack_gmod_ezironore.lua"
...
elseif CLIENT then
	function ENT:Draw()
		...
		JMod.HoloGraphicDisplay(self, Vector(0, -12, 1), Angle(90, 0, 90), .04, 300, function()
			JMod.StandardResourceDisplay(JMod.EZ_RESOURCE_TYPES.IRONORE, self:GetResource(), nil, 0, 0, 200, true)
		end)
	end
