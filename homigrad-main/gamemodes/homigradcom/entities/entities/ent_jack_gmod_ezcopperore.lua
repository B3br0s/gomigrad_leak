-- "gamemodes\\homigradcom\\entities\\entities\\ent_jack_gmod_ezcopperore.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal﻿-- Jackarunda 2021
AddCSLuaFile()
ENT.Base = "ent_jack_gmod_ezresource"
ENT.PrintName = "EZ Copper Ore"
ENT.Category = "JMod - EZ Resources"
ENT.IconOverride = "materials/ez_resource_icons/copper ore.png"
ENT.Spawnable = true
...
elseif CLIENT then
	function ENT:Draw()
		...
		JMod.HoloGraphicDisplay(self, Vector(0, -12, 1), Angle(90, 0, 90), .04, 300, function()
			JMod.StandardResourceDisplay(JMod.EZ_RESOURCE_TYPES.COPPERORE, self:GetResource(), nil, 0, 0, 200, true)
		end)
	end
