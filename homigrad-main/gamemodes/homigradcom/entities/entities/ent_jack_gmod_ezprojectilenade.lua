-- "gamemodes\\homigradcom\\entities\\entities\\ent_jack_gmod_ezprojectilenade.lua"
...
if SERVER then
	...
	function ENT:Detonate()
		...
		self.Exploded = true
		JMod.Sploom(self:GetOwner() or self, self:GetPos() + Vector(0, 0, 10), self.Damage ^ .95, self.BlastRadius)
		self:Remove()
	end
elseif CLIENT then
	function ENT:Initialize()
