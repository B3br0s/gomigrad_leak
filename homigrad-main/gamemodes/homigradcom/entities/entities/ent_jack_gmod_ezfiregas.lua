-- "gamemodes\\homigradcom\\entities\\entities\\ent_jack_gmod_ezfiregas.lua"
...
elseif CLIENT then
	...
	function ENT:DrawTranslucent()
		...
		if self.Show then
			...
			render.DrawSprite(SelfPos, self.siz, self.siz, Color(self.Col.r, self.Col.g, self.Col.b, 55))
