-- "lua\\homigrad_scr\\game\\tier_0\\oop\\vgui\\tier_1\\scrollpanel_cl.lua"
...
--
function PANEL:TransformHook()
	self:GetParent():Event_Call("Transform Child")
end

function PANEL:MouseWheelHook(wheel)
	self:GetParent():Event_Call("Mouse Wheel", wheel, true)
end
...
PANEL:Event_Add("Transform", "Main", function(self)
	self:TransformCanvasPanel()
end)
...
timer.Simple(0, function()
	...
	testPanel:Transform() -- always needed
end) --]]