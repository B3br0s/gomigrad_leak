-- "lua\\homigrad_scr\\game\\tier_0\\oop\\vgui\\tier_1\\button_cl.lua"
...
PANEL:Event_Add("Init", "Main", function(self)
	self:Color_Manual("main", {
		main = vgui_color.main
	}, 0.1)
...
PANEL:Event_Add("Draw", "Main", function(self, w, h, color)
	...
	draw.SimpleText(self.Title, self.TitleFont, (down and self.TitleDownX or 0) + w / 2, (down and self.TitleDownY or 0) + h / 2, color.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
end)
