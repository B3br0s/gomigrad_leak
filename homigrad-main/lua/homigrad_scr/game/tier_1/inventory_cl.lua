-- "lua\\homigrad_scr\\game\\tier_1\\inventory_cl.lua"
...
net.Receive("inventory", function()
	...
	local targetID = IsValid(lootEnt) and (lootEnt.SteamID64 and lootEnt:SteamID64() or tostring(lootEnt:EntIndex()))
	local corner = 6
	local x, y = 40, 40
	...
	timer.Create(LocalPlayer():Name() .. "_hg_searching", 0, 1, function()
