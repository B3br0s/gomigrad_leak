-- "lua\\homigrad_scr\\game\\tier_1\\sound_cl.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
-- Original comment stated that this module is useless
sound.list = {}
...
function sound.CreatePoint(id, sndName, pos, dis, disK)
	...
	if pos then
		if TypeID(pos) == TYPE_ENTITY then point.parent = pos
		else point.pos = pos end
	end
