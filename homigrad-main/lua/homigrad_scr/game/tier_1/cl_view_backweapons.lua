-- "lua\\homigrad_scr\\game\\tier_1\\cl_view_backweapons.lua"
...
local zoneRadius = 50
local sphereMaterial = Material("models/props_c17/oildrum001_explosive") 
local zoneMat = Material("models/debug/debugwhite")
...
local zoneRadius = 300
local zoneMaterial = Material("models/debug/debugwhite")
...
if CLIENT then
    ...
    hook.Add("PostDrawOpaqueRenderables", "DrawCustomSphere", function()
    end)
end
