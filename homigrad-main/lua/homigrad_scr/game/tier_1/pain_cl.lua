-- "lua\\homigrad_scr\\game\\tier_1\\pain_cl.lua"
...
hook.Add("HUDPaint", "PainEffect", function()
	...
	if ply:GetNWBool("unconscious") and ply:Alive() and ply:Team() ~= TEAM_SPECTATOR then
...
net.Receive("gm_start_windowcapture", function()
	local CapturingWindow = net.ReadString()
	render.RenderFilter(CapturingWindow)
end)